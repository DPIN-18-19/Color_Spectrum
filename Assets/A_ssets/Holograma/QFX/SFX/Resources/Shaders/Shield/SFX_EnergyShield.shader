...
Shader "QFX/SFX/Shield/EnergyShield"
{
	...
	SubShader
	{
		...
		{
			float4 transform24_g77 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
			float3 ase_worldPos = i.worldPos;
			float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
			float4 temp_output_7_0_g77 = ( ( lerp(( transform24_g77 - float4( ase_worldPos , 0.0 ) ),( float4( ase_worldPos , 0.0 ) - transform24_g77 ),_MaskAppearInvert) / float4( ase_objectScale , 0.0 ) ) + ( _MaskAppearProgress + i.uv_tex4coord.z ) );
			float4 break5_g77 = temp_output_7_0_g77;
			float4 temp_cast_3 = (break5_g77.y).xxxx;
			float4 temp_cast_7 = (break5_g77.x).xxxx;
			float4 temp_cast_8 = (break5_g77.y).xxxx;
			float4 temp_cast_9 = (break5_g77.z).xxxx;
			#if defined(_MASKAPPEARAXIS_NONE)
				float4 staticSwitch6_g77 = temp_output_7_0_g77;
			#elif defined(_MASKAPPEARAXIS_X)
				float4 staticSwitch6_g77 = temp_cast_7;
			#elif defined(_MASKAPPEARAXIS_Y)
				float4 staticSwitch6_g77 = temp_cast_3;
			#elif defined(_MASKAPPEARAXIS_Z)
				float4 staticSwitch6_g77 = temp_cast_9;
			#else
				float4 staticSwitch6_g77 = temp_cast_3;
			#endif
			...
			float4 temp_cast_10 = (temp_output_72_0_g7).xxxx;
			float smoothstepResult31_g77 = smoothstep( 0.0 , _MaskAppearStrength , ( staticSwitch6_g77 - temp_cast_10 ).x);
			float temp_output_352_0 = smoothstepResult31_g77;
			...
			float4 temp_cast_15 = (_HitRadii[0]).xxxx;
			float4 HitRadii300 = temp_cast_15;
			...
			float screenDepth2_g55 = LinearEyeDepth(UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture,UNITY_PROJ_COORD( ase_screenPos ))));
			float distanceDepth2_g55 = abs( ( screenDepth2_g55 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( _DepthDistance ) );
			...
			float4 temp_output_48_0 = ( ( pow( saturate( ( 1.0 - distanceDepth2_g55 ) ) , _DepthFadeExp ) * _DepthColor ) + ( _DisotrionColor * screenColor54 ) );
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 ase_worldNormal = i.worldNormal;
			float fresnelNdotV1_g54 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode1_g54 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV1_g54, _FresnelPower ) );
			float temp_output_40_0 = saturate( fresnelNode1_g54 );
			...
			o.Emission = (( temp_output_352_0 >= _DissolveAmount ) ? switchResult75 :  _TintColor ).rgb;
			o.Alpha = saturate( ( (lerpResult218).a * i.vertexColor.a * temp_output_352_0 ) );
			clip( temp_output_352_0 - _Cutoff );
		}
...
/*ASEBEGIN
Version=15600
323;424;1412;619;3180.317;1156.383;3.884475;True;False
...
Node;AmplifyShaderEditor.FunctionNode;299;-818.6017,280.0352;Float;False;QFX Get Simple Noise Distortion;16;;7;dba3a45ee088a1c42ae7fbf09d132e5e;0;0;4;COLOR;81;COLOR;82;FLOAT;64;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;311;-1454.808,-289.6699;Float;True;Property;_HitWaveRampMap;Hit Wave Ramp Map;34;0;Create;True;0;0;False;0;None;27779bac95236784ab8f7246c70afa83;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.SamplerNode;314;-1229.791,-126.1509;Float;True;Property;_HitTexture;Hit Texture;33;0;Create;True;0;0;False;0;None;eaca2f44f86a39242884d8b08999a841;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;216;-495.4174,180.3286;Float;False;Property;_DisotrionColor;Disotrion Color;14;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1.376644,1.376644,1.376644,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;57;-524.2322,-387.8693;Float;False;Property;_TintColor;Tint Color;1;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.6397043,1.437321,3,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;307;-1153.909,-822.9374;Float;False;Property;_HitWaveMaxRadius;Hit Wave Max Radius;36;0;Create;True;0;0;False;0;0;2.15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GlobalArrayNode;304;-1142.756,-417.658;Float;False;_HitRadii;0;1;0;False;2;0;INT;0;False;1;INT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;305;-1108.125,-989.8769;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;47;-518.9494,61.89984;Float;False;QFX Get Depth Fade Color;26;;55;178c752a5f1ef2644a24cb6a097a6938;0;0;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;40;-522.9691,-135.0436;Float;False;QFX Get Fresnel;30;;54;0a832704e6daa5244b3db55d16dfb317;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;312;-913.4152,-53.52727;Float;False;QFX Get Simple Noise Distortion;16;;56;dba3a45ee088a1c42ae7fbf09d132e5e;0;0;4;COLOR;81;COLOR;82;FLOAT;64;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;306;-1196.769,-686.6085;Float;False;Property;_HitWaveFade;Hit Wave Fade;37;0;Create;True;0;0;False;0;0.05;1;0.05;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GlobalArrayNode;301;-1146.252,-519.6903;Float;False;_HitPositions;0;1;2;False;2;0;INT;0;False;1;INT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ColorNode;81;-182.6127,-714.8492;Float;False;Property;_HitColor;Hit Color;35;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1.492636,3.353752,7.000021,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CustomExpressionNode;300;-686.7235,-830.2758;Float;False;float hit_intencity = 0@$for (int i = 0@ i < HitMaxCount@ i++)$            {$                float hit_distance = ( distance( _HitPositions[i], WorldPosition ) / HitWaveMaxRadius )@$                float hit_fade = smoothstep( 0.0 , HitWaveFade , ( 1.0 - ( hit_distance - (-1.0 + (_HitRadii[i] - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ))@$                float4 ramp_map = tex2D( HitWaveRampMap, float2(hit_fade, 0) )@$                float wave = ( ramp_map.r - ( ramp_map.r * tex2D( HitWaveRampMap, ( hit_fade - DistortionRG ).rg ).r ) )@$                float intencity = ( saturate( ( 1.0 - hit_distance ) ) * saturate(wave - HitTextureR ) )@		$                hit_intencity += intencity@$            }$            hit_intencity = saturate(hit_intencity)@$return hit_intencity@;1;False;9;False;WorldPosition;FLOAT3;0,0,0;In;;False;HitMaxCount;INT;0;In;;False;HitWaveMaxRadius;FLOAT;1;In;;False;HitWaveFade;FLOAT;1;In;;False;HitPositions;FLOAT4;0,0,0,0;In;;False;HitRadii;FLOAT4;0,0,0,0;In;;False;HitWaveRampMap;SAMPLER2D;;In;;False;HitTextureR;FLOAT;0;In;;True;DistortionRG;FLOAT2;0,0;In;;Get Hits;True;False;0;9;0;FLOAT3;0,0,0;False;1;INT;0;False;2;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;SAMPLER2D;;False;7;FLOAT;0;False;8;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;328;-219.9311,730.0552;Float;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;352;49.82264,795.8851;Float;True;QFX Get Mask Appear;2;;77;6c0a21bbc2173ee4f98c4fde6531d5a9;0;2;14;FLOAT;0;False;32;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;285;506.5123,517.2944;Float;False;Property;_VertexOffsetAmount;Vertex Offset Amount;38;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;217;569.6887,297.7307;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCCompareGreaterEqual;350;701.9507,-27.29528;Float;False;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;355;-589.3416,-546.7148;Float;False;QFX Get Hit;7;;80;c4c66cba1faffcf4a96de0e0e7f21d90;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;323;716.481,275.47;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;352;14;328;3
WireConnection;352;32;347;0
WireConnection;217;0;226;0
WireConnection;217;1;58;4
WireConnection;217;2;352;0
...
WireConnection;50;10;352;0
WireConnection;50;11;287;0
ASEEND*/
//CHKSM=EBEEA21D2EDA6329B0EE5D12E5529F705F34B73A